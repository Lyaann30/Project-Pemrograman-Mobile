...
class KeranjangMs1View extends StatefulWidget {
  const KeranjangMs1View({super.key});

  @override
  _KeranjangMS1ViewState createState() => _KeranjangMS1ViewState();
}

class _KeranjangMS1ViewState extends State<KeranjangMs1View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('Nmmaj8kBw3z438jcln8z') // Replace with the actual product ID
        .get();
  }
