...
class Kamarspanyol1View extends StatefulWidget {
  const Kamarspanyol1View({Key? key}) : super(key: key);

  @override
  State<Kamarspanyol1View> createState() => _Kamarspanyol1ViewState();
}

class _Kamarspanyol1ViewState extends State<Kamarspanyol1View> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Kamar Spanyol menghadirkan suasana hangat dengan warna merah bata '
                'dan krem. Furnitur kayu berukir yang kokoh dan tempat tidur besar '
                'dengan sprei cerah memberikan nuansa klasik.',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.black,
                ),
