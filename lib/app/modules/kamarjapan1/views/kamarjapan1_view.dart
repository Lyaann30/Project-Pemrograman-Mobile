...
class Kamarjapan1View extends StatefulWidget {
  const Kamarjapan1View({Key? key}) : super(key: key);

  @override
  State<Kamarjapan1View> createState() => _Kamarjapan1ViewState();
}

class _Kamarjapan1ViewState extends State<Kamarjapan1View> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Desain kamar bernuansa Jepang menampilkan kesederhanaan dengan '
                'elemen kayu, tatami, pintu geser shoji, dan dekorasi minimalis, '
