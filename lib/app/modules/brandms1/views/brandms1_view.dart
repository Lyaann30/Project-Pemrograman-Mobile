...
import 'package:myapp/app/modules/keranjang_ms1/views/keranjang_ms1_view.dart';

class Brandms1View extends StatefulWidget {
  @override
  _Brandms1ViewState createState() => _Brandms1ViewState();
}

class _Brandms1ViewState extends State<Brandms1View> {
  final AuthController authController = Get.find<AuthController>();
  int quantity = 1;
  bool isInWishlist = false;
  final String productId = 'Nmmaj8kBw3z438jcln8z';
