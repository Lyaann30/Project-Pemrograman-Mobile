...
class KeranjangFm1View extends StatefulWidget {
  const KeranjangFm1View({super.key});

  @override
  _KeranjangFM1ViewState createState() => _KeranjangFM1ViewState();
}

class _KeranjangFM1ViewState extends State<KeranjangFm1View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('Ars68jF4A9gxU78LGVy7') // Replace with the actual product ID
        .get();
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          List<dynamic> additionalImages = productData['additional_images'] ?? [];
                        ...
                        for (int i = 0; i < additionalImages.length; i++)
                          Padding(
                            ...
                            child: Transform.translate(
                              offset: Offset(-90.0 * i, 0), // Horizontal offset for overlapping effect
                              child: Container(
                                height: 150,
                                width: 150,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            await authController.addToCart(productData, quantity);
