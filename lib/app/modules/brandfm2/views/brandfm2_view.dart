...
class Brandfm2View extends StatefulWidget {
  @override
  _Brandfm2ViewState createState() => _Brandfm2ViewState();
}

class _Brandfm2ViewState extends State<Brandfm2View> {
  final AuthController authController = Get.find<AuthController>();
  int quantity = 1;
  bool isInWishlist = false;
  final String productId = 'O20uXJNJggTfZecvKghj';
