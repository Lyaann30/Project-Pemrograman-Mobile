...
import 'package:myapp/app/modules/keranjang_hm2/views/keranjang_hm2_view.dart';

class Brandhm2View extends StatefulWidget {
  @override
  _Brandhm2ViewState createState() => _Brandhm2ViewState();
}

class _Brandhm2ViewState extends State<Brandhm2View> {
  final AuthController authController = Get.find<AuthController>();
  int quantity = 1;
  bool isInWishlist = false;
  final String productId = 'T9yv4ylWuPxq8y6OhaGY';
