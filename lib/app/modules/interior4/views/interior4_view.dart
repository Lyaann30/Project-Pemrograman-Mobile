...
class Interior4View extends StatefulWidget {
  const Interior4View({Key? key}) : super(key: key);

  @override
  State<Interior4View> createState() => _Interior4ViewState();
}

class _Interior4ViewState extends State<Interior4View> {
  // 6 controllers
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Ruang tamu bergaya kontemporer dengan nuansa Eropa modern. Dinding berwarna netral berpadu dengan perapian minimalis, rak terbuka, dan dekorasi hijau yang segar. Furnitur modern yang bersih dan fungsional memberikan kesan ruang yang luas, mewah, dan nyaman. Pilihan sempurna untuk gaya hidup masa kini.',
