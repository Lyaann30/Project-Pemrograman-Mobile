...
class KeranjangVd1View extends StatefulWidget {
  const KeranjangVd1View({super.key});

  @override
  _KeranjangVD1ViewState createState() => _KeranjangVD1ViewState();
}

class _KeranjangVD1ViewState extends State<KeranjangVd1View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('ISqlLmEY46fOfcdh1CCz') // Replace with the actual product ID
        .get();
  }
