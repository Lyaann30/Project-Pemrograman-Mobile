                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return wishlistItem(
                      ...
                      price: wishlistData['price']?.toString() ?? '0',
                        ...
                        onPressed: () async {
                          ...
                          if (user != null) {
                            await FirebaseFirestore.instance.collection('cart').add({
                              ...
                              'price': price,
                              'size': size,
                              'quantity': int.tryParse(quantity) ?? 1, // Konversi String ke int
                              'imageUrl': imageUrl, // Perhatikan nama field
                            });
