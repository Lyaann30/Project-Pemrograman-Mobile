...
class KeranjangHm2View extends StatefulWidget {
  const KeranjangHm2View({super.key});

  @override
  _KeranjangHM2ViewState createState() => _KeranjangHM2ViewState();
}

class _KeranjangHM2ViewState extends State<KeranjangHm2View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('T9yv4ylWuPxq8y6OhaGY') // Replace with the actual product ID
        .get();
  }
