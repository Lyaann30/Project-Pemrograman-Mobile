...
class Interior2View extends StatefulWidget {
  const Interior2View({Key? key}) : super(key: key);

  @override
  State<Interior2View> createState() => _Interior2ViewState();
}

class _Interior2ViewState extends State<Interior2View> {
  // 6 controller
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Elegansi klasik bertemu dengan desain modern di ruang tamu ini. Elemen kayu alami pada lantai dan meja memberikan kehangatan, sementara jendela besar memastikan pencahayaan alami maksimal. Permadani bermotif tradisional menjadi aksen yang memperkuat karakter ruangan, menciptakan harmoni antara estetika klasik dan fungsionalitas kontemporer.',
