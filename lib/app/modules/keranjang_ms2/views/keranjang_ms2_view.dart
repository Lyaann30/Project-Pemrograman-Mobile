...
class KeranjangMs2View extends StatefulWidget {
  const KeranjangMs2View({super.key});

  @override
  _KeranjangMS2ViewState createState() => _KeranjangMS2ViewState();
}

class _KeranjangMS2ViewState extends State<KeranjangMs2View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('fribl2C4v3u6tC1PWl8c') // Replace with the actual product ID
        .get();
  }
