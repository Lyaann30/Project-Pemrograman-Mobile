...
class KeranjangVd2View extends StatefulWidget {
  const KeranjangVd2View({super.key});

  @override
  _KeranjangVD2ViewState createState() => _KeranjangVD2ViewState();
}

class _KeranjangVD2ViewState extends State<KeranjangVd2View> {
  int quantity = 1;
  ...
  Future<DocumentSnapshot> getProductData() async {
    return await FirebaseFirestore.instance
        .collection('products')
        .doc('CQSFcTtIahqYEwXIsFVh') // Replace with the actual product ID
        .get();
  }
