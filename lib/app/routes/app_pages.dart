...
import '../modules/admin_pesanan/bindings/admin_pesanan_binding.dart';
import '../modules/admin_pesanan/views/admin_pesanan_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.ADMIN_PESANAN,
      page: () => const AdminPesananView(),
      binding: AdminPesananBinding(),
    ),
